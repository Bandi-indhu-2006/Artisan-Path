...
export default function Shop() {
  ...
  const filteredProducts = products
    .filter(p => p.title.toLowerCase().includes(search.toLowerCase()) || p.artisanName.toLowerCase().includes(search.toLowerCase()))
    .sort((a, b) => b.averageRating - a.averageRating);

  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 space-y-4">
        <h1 className="text-3xl font-serif font-bold text-foreground">Bazaar</h1>
        <p className="text-muted-foreground">Discover handcrafted treasures from artisans across India.</p>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 bg-card rounded-xl border border-border">
          ...
          <h3 className="text-lg font-medium">No crafts found</h3>
